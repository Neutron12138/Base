...
#define BASE_DECLARE_REF_TYPE_SHARED(class_name)     \
    class class_name;                                \
    using class_name##Ref = ::base::Ref<class_name>; \
    using class_name##WeakRef = ::base::WeakRef<class_name>;

#define BASE_DECLARE_REF_TYPE_UNIQUE(class_name) \
    class class_name;                            \
...
#define BASE_DECLARE_REF_TEMPLATE_TYPE_SHARED(class_name)           \
    template <typename template_type>                               \
    class class_name;                                               \
    template <typename template_type>                               \
    using class_name##Ref = ::base::Ref<class_name<template_type>>; \
    template <typename template_type>                               \
    using class_name##WeakRef = ::base::WeakRef<class_name<template_type>>;

#define BASE_DECLARE_REF_TEMPLATE_TYPE_UNIQUE(class_name) \
    template <typename template_type>                     \
    class class_name;                                     \
    template <typename template_type>                     \
    using class_name##UniqueRef = ::base::UniqueRef<class_name<template_type>>;

#define BASE_DECLARE_REF_TEMPLATE_TYPE(template_type, class_name)           \
    template <typename template_type>                                       \
    class class_name;                                                       \
    template <typename template_type>                                       \
    using class_name##Ref = ::base::Ref<class_name<template_type>>;         \
