...
namespace base
{
    class DynamicClassInfoRegister;
    using DynamicClassInfoRegisterRef = Ref<DynamicClassInfoRegister>;
    using DynamicClassInfoWeakRef = WeakRef<DynamicClassInfoRegister>;
