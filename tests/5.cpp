...
void test1()
{
    ...
    base::GlobalField<int> _val(&val);
    base::GlobalMethod<void> _output(&output);
    base::GlobalMethod<void, int> _set(&set);
    base::GlobalMethod<int> _get(&get);
...
void test2()
{
    auto class_info = std::make_shared<base::ClassInfoRegister<MyClass>>();
    ...
    base::ClassInfo::BaseClassArray base_classes = {class_info};
    auto class_info2 = std::make_shared<base::DynamicClassInfoRegister>(base_classes);
